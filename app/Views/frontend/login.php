...
<body class="login-page bg-body-secondary">
    <div class="login-box">
        <div class="login-logo"> <a href="../index2.html"><b>Disnakertrans Manokwari</b></a> </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Masuk untuk mengelola akun Pencaker</p>
                ...
                <div class="social-auth-links text-center mb-3 d-grid gap-2">
                    <p>- OR -</p> <a href="#" class="btn btn-danger"> <i class="bi bi-google me-2"></i> Masuk Dengan
                        Google+
                    </a>
                </div> <!-- /.social-auth-links -->
                <p class="mb-1"> <a href="<?= base_url('forgotpassword'); ?>">Lupa Kata Sandi ?</a> </p>
                <p class="mb-1"> <a href="<?= base_url('registrasi'); ?>" class="text-center">
                        Registrasi Akun Pencaker
                    </a> </p>
                <p class="mb-1"> <a href="<?= base_url(); ?>" class="text-center">
