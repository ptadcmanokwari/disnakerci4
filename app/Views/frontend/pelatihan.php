                    ...
                    <article>
                        <div class="card border-0">
                            <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                                <a href="<?= base_url('pelatihan/' . $item['slug']) ?>">
                                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?= base_url('uploads/pelatihan/' . $item['gambar']) ?>" alt="<?= $item['kategori'] ?>">
                                </a>
                                <figcaption>
                            ...
                            <div class="card-body border bg-white p-4">
                                <div class="entry-header mb-3">
                                    <h2 class="card-title entry-title h4 mb-0">
                                        <a class="link-dark text-decoration-none" href="<?= base_url('pelatihan/' . $item['slug']) ?>"><?= $item['judul'] ?></a>
                                    </h2>
                                </div>
