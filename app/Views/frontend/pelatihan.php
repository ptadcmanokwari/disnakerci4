        ...
        <div class="row mt-4">
                ...
                <?php else : ?>
                    <?php foreach ($informasi as $info) : ?>
                        <div id="listBerita" class="row py-2 my-2">
                            <div class="col-lg-4">
                                <div class="entry-img">
                                    <img src="<?= base_url('uploads/pelatihan/' . $info['gambar']); ?>" alt="" class="img-fluid">
                                </div>
                            </div>
            ...
            <div class="col-lg-4 py-0">
                <div class="sidebar py-0">
                    <h3 class="sidebar-title">Pelatihan Terbaru</h3>
                        ...
                        <?php else : ?>
                            <?php foreach ($recentPosts as $post) : ?>
                                <div class="post-item clearfix">
                                    <img src="<?= base_url('uploads/pelatihan/' . $post['gambar']); ?>" alt="">
