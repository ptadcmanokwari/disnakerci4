...
<section id="blog" class="blog">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            ...
            <?php else : ?>
                <p>Temukan pengumuman terbaru tentang Dianas Ketenagakerjaan dan Transmigrasi Kabupaten Manokwari</p>
            <?php endif; ?>
        </div>
                        ...
                        <div class="entry-meta">
                            <ul>
                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <time datetime="<?= $item['tgl_publikasi']; ?>"><?= tanggal_indo($item['tgl_publikasi']); ?></time>
                                </li>
