        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li class="dropdown">
                        <a <?= ($current_uris['segment_1'] == 'kartu_ak1') ? 'class="active"' : '' ?> href="#"><span>Layanan</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a <?= ($current_uris['segment_1'] == 'kartu_ak1') ? 'class="active"' : '' ?> href="<?= base_url('kartu_ak1'); ?>">Kartu Pencari Kerja (Kartu Ak/1)</a></li>
                        </ul>
                    </li>
