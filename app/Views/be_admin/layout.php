            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item"> <a href="<?= base_url('admin/dashboard'); ?>"
                                class="nav-link <?= ($current_uri == 'dashboard') ? 'active' : '' ?>"> <i
                                    class="nav-icon bi bi-laptop"></i>
                                <p>Dashboard</p>
                            </a> </li>

                        <li class="nav-item"> <a href="<?= base_url('admin/pencaker'); ?>"
                                class="nav-link <?= ($current_uri == 'pencaker') ? 'active' : '' ?>"> <i
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="<?= base_url('admin/berita'); ?>"
                                        class="nav-link <?= ($current_uri == 'berita') ? 'active' : '' ?>"> <i
                                            class="nav-icon bi bi-circle"></i>
                                        <p>Berita</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="<?= base_url('admin/pengumuman'); ?>"
                                        class="nav-link <?= ($current_uri == 'pengumuman') ? 'active' : '' ?>">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Pengumuman</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="<?= base_url('admin/pelatihan'); ?>"
                                        class="nav-link <?= ($current_uri == 'pelatihan') ? 'active' : '' ?>"> <i
                                            class="nav-icon bi bi-circle"></i>
                                        <p>Pelatihan</p>
                                    </a> </li>
                            </ul>
                        ...
                        <li class="nav-item"> <a href="<?= base_url('admin/userslog'); ?>"
                                class="nav-link <?= ($current_uri == 'userslog') ? 'active' : '' ?>"> <i
                                    class="nav-icon bi bi-clock-history"></i>
                                <p>Aktivitas Pengguna</p>
                            </a> </li>
                        <li class="nav-header">SUPER ADMIN</li>

                        <li class="nav-item"> <a href="<?= base_url('admin/users'); ?>"
                                class="nav-link <?= ($current_uri == 'users') ? 'active' : '' ?>"> <i
                                    class="nav-icon bi bi-person-fill-gear"></i>
                                <p>Users</p>
                            </a> </li>

                        <li class="nav-item"> <a href="<?= base_url('admin/settings'); ?>"
                                class="nav-link <?= ($current_uri == 'settings') ? 'active' : '' ?>"> <i
                                    class="nav-icon bi bi-gear"></i>
                                <p>Settings</p>
                            </a> </li>

                        <li class="nav-item"> <a href="<?= base_url('admin/backup'); ?>"
                                class="nav-link <?= ($current_uri == 'backup') ? 'active' : '' ?>"> <i
                                    class="nav-icon bi bi-database-fill-down"></i>
                                <p>Backup</p>
                            </a> </li>
