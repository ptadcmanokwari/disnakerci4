        ...
        <div class="container-fluid">
            ...
            <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img"
                                                        src="<?= base_url(); ?>adminlte/dist/assets/img/user7-128x128.jpg"
                                                        alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            Sarah Doe
                                                            <small class="contacts-list-date float-end">
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img"
                                                        src="<?= base_url(); ?>adminlte/dist/assets/img/user5-128x128.jpg"
                                                        alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            Nora S. Vans
                                                            <small class="contacts-list-date float-end">
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img"
                                                        src="<?= base_url(); ?>adminlte/dist/assets/img/user6-128x128.jpg"
                                                        alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            John K.
                                                            <small class="contacts-list-date float-end">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <div class="row text-center m-1">
                                        ...
                                        <div class="col-3 p-2"> <img class="img-fluid rounded-circle"
                                                src="<?= base_url(); ?>adminlte/dist/assets/img/user4-128x128.jpg"
                                                alt="User Image"> <a
                                                class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                href="#">
                                                Nora
                ...
                <div class="col-md-4">
                    ...
                    <div class="info-box mb-3 text-bg-danger"> <span class="info-box-icon"> <i
                    ...
                    <div class="info-box mb-3 text-bg-info"> <span class="info-box-icon"> <i
                        ...
                        <div class="card-body p-0">
                            <div class="px-2">
                                <div class="d-flex border-top py-2 px-1">
                                    <div class="col-2"> <img
                                            src="<?= base_url(); ?>adminlte/dist/assets/img/default-150x150.png"
