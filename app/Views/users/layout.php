    ...
    <div class="app-wrapper">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="../layout/fixed-complete.html" class="nav-link active">
        ...
        <div class="app-main-wrapper">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#"
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="fs-7 text-secondary"> <i class="bi bi-clock-fill me-1"></i> 4
                                                Hours Ago
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools"> <button type="button" class="btn btn-tool"
                                                data-lte-toggle="card-collapse" title="Collapse"> <i
            ...
            <div class="app-content-bottom-area">
                <div class="row">
                    <div class="col-12 text-end"> <button type="submit" class="btn btn-primary" name="save"
